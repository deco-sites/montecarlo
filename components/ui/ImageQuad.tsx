...
function WrapperImage({ children }: Wrapper) {
  return (
    <div class="relative w-full md:w-2/4">
      ...
      <div class="absolute overflow-y-hidden w-full h-full bg-gradient-to-t from-[#01010157] to-transparent top-0">
      </div>
    </div>
  );
}

export default function ImageQuad(
    ...
    <div class={"container flex flex-col py-8 sm:flex-wrap sm:flex-row"}>
      <WrapperImage>
        <SectionImage
          props={firstImage}
          customClass={"mt-[-2px]"}
          wrapperCustomClass={`w-full lg:w-full`}
          infoSectionCustomClass={`absolute top-0 z-10`}
        />
      </WrapperImage>

...
export default function Select({ placeholderCity, button, searchStore, placeholderState }: Props) {
    ...
    function Storange() {
        const obj = { selectedState: state.current?.value, selectedCity: city.current?.value };

              ...
              <div class="px-2 relative">
                <label class="peer absolute -top-9 left-0 right-0 flex cursor-pointer flex-row items-center justify-center px-3 py-1">
                  <input
                    ...
                    checked={true}
                  />
                  <span class="left-0 -ml-4 bg-primary w-8 h-8 flex justify-center items-center peer-checked:translate-y-[-47px] z-30 translate-y-[-316px] duration-300 ease-in-out"></span>
                  <div class=" h-4 w-4 -rotate-45 border-2 left-[47.7%] absolute peer-checked:translate-y-[-47px] z-30 translate-y-[-316px] border-black duration-300 ease-in-out before:absolute before:bottom-0 before:h-4 before:w-4 before:bg-primary top-3 peer-checked:top-[15px] peer-checked:rotate-[135deg]"></div>

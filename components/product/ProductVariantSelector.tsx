          ...
          ? (
            <div class="flex flex-col gap-1">
              ...
              <div class="relative w-fit">
                <label class={`peer relative flex flex-row items-center justify-between border px-3 py-1 ${isVariantOf && isVariantOf.hasVariant.length > 1 ? "cursor-pointer" : "cursor-default"}`}>
                  ...
                  {isVariantOf && isVariantOf.hasVariant.length > 1 && <div class="h-2 w-2 -rotate-45 border-2 border-black duration-300 ease-in-out before:absolute before:bottom-0 before:h-2 before:w-2 before:bg-white peer-checked:rotate-[135deg]">
                  </div>}
                </label>

...
export default function ButtonDotsControl({dotsActive, setDotsActive}: Props) {
    ...
    return (
        <button
            ...
            class={`${dotsActive && "rotate-45"} absolute flex justify-center items-center bottom-5 lg:bottom-8 left-5 lg:left-8 bg-[#FFC72C] p-2 w-10 h-10 transition-transform`}
        >
            <svg
            ...
            >
                <path d="M11.1934 4.5C11.1934 2.01871 9.39895 0 7.19336 0C4.98773 0 3.19336 2.01871 3.19336 4.5H0.193359V15.1875C0.193359 16.7408 1.31264 18 2.69336 18H11.6934C13.0741 18 14.1934 16.7408 14.1934 15.1875V4.5H11.1934ZM7.19336 1.125C8.84758 1.125 10.1934 2.639 10.1934 4.5H4.19336C4.19336 2.639 5.53914 1.125 7.19336 1.125ZM13.1934 15.1875C13.1934 16.118 12.5205 16.875 11.6934 16.875H2.69336C1.86627 16.875 1.19336 16.118 1.19336 15.1875V5.625H3.19336V7.3125C3.19336 7.62318 3.41723 7.875 3.69336 7.875C3.96948 7.875 4.19336 7.62318 4.19336 7.3125V5.625H10.1934V7.3125C10.1934 7.62318 10.4172 7.875 10.6934 7.875C10.9695 7.875 11.1934 7.62318 11.1934 7.3125V5.625H13.1934V15.1875Z" fill="black" />
            </svg>

...
export default function Info({ coords }:{ coords: string[] }) {
    ...
    return (
        <div class={`flex ${x} ${y} absolute invisible bg-white group-hover:visible group-data-[active=true]:visible opacity-0 group-hover:opacity-100 group-data-[active=true]:opacity-100 group-hover:z-10 group-data-[active=true]:z-10 transition-opacity w-max`}>
            <div class="h-full">
                <Image class="w-28 h-auto max-w-[20vw] object-cover" src="https://placehold.co/112x112" width={112} height={112} />
            </div>

    ...
    return (
        <div class="flex w-full flex-col py-8 items-center lg:py-8 gap-5 lg:gap-10">
            <div class="flex flex-col w-full gap-1 items-center">
                ...
                {subTitle && (
                    <span dangerouslySetInnerHTML={{ __html: subTitle }} class=" font-medium  text-sm lg:text-base"></span>
                )}
            </div>
            <div
                class="flex flex-col w-full h-full gap-2 lg:flex-row lg:justify-center max-w-[1408px]"
            >
